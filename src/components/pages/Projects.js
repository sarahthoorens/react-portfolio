            ...
            <a href={project.link} key={project.image[index]} className="sm:w-1/2 w-100 p-4">
              <div className="flex relative">
                <img alt="featured-project-preview" className="max-h-full mx-auto border-4 border-indigo rounded-xl"
                  src={project.image}/>
                  <div className="px-5 py-5 absolute max-h-fit mx-auto p-2 z-10 border-4 top-1 bottom-1 left-1 right-1 max-w-fit border-vanilla bg-indigo opacity-0 hover:opacity-95 bg-navy">
